...
public class SolarPanelBlockItem extends BlockItem
{
	...
	public SolarPanelBlockItem(SolarPanelBlock blockIn, Properties builder)
	{
		...
		setRegistryName(Objects.requireNonNull(blockIn.getRegistryName()));
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, @Nonnull ITooltipFlag flagIn)
	{
		...
		if(stack.hasTag()) {
			...
			if (stack.getTag().contains("Upgrades") || stack.getTag().contains("Energy") || stack.getTag().contains("Chargeable")) {
